...
<div class="h-full w-full bg-slate-500 overflow-auto">
	...
	>
		...
		<div class="flex overflow-x-scroll h-full w-full gap-10 p-3">
			<div
				id="work-1"
				class="flex flex-shrink-0 flex-col items-center h-full w-full bg-slate-100 justify-center gap-5 rounded-md"
			>
			...
			<div
				id="work-2"
				class="flex border flex-shrink-0 w-full flex-col items-center justify-center gap-5"
			>
